...
void DDA(int x0, int y0, int x1, int y1)
{
	...
	int steps;
	if (abs(dx) >= abs(dy)) // Slope m is less than or equal 1
    {
        steps = abs(dx);
    }
...
int main()
{
	...
	initwindow(width, height, "Bresenham's Line Drawing Algorithm");
